...
extension UIViewController {
    ...
    func addTopRightButton(target: UIViewController?, selector: Selector?, title: String, style: UIBarButtonItem.Style = .plain) {
		...
		let attributes = [NSAttributedString.Key.foregroundColor: Asset.Colors.main.color,
                          NSAttributedString.Key.font: FontFamily.AvenirNextCyr.medium.font(size: 16) ?? Font.systemFont(ofSize: 16)]
